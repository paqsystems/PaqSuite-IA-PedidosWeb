...
return [
    ...
    'defaults' => [
        ...
        'ModificaCondVtaC' => (int) env('PAQSWEB_MODIFICA_COND_VTA_C', 0),
        'ModificaCondVtaV' => (int) env('PAQSWEB_MODIFICA_COND_VTA_V', 1),
        'ModificaCondVtaS' => (int) env('PAQSWEB_MODIFICA_COND_VTA_S', 1),
        'ModificaDirEntrC' => (int) env('PAQSWEB_MODIFICA_DIR_ENTR_C', 1),
        'ModificaDirEntrV' => (int) env('PAQSWEB_MODIFICA_DIR_ENTR_V', 1),
        'ModificaDirEntrS' => (int) env('PAQSWEB_MODIFICA_DIR_ENTR_S', 1),
        'ModificaExpresoC' => (int) env('PAQSWEB_MODIFICA_EXPRESO_C', 1),
        'ModificaExpresoV' => (int) env('PAQSWEB_MODIFICA_EXPRESO_V', 1),
        'ModificaExpresoS' => (int) env('PAQSWEB_MODIFICA_EXPRESO_S', 1),
