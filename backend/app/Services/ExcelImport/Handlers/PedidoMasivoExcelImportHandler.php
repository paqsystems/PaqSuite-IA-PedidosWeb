...
final class PedidoMasivoExcelImportHandler implements ExcelImportLotAwareHandler
{
    public const CODIGO_PROCESO = 'PEDIDO_MASIVO';

    public function __construct(
        private readonly PedidoIndividualRowResolver $rowResolver,
        private readonly PedidoMasivoLotValidator $lotValidator,
    ) {}
