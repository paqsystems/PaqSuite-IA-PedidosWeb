...
| **Contrato datos** | [TR-SPEC-101-14-dashboard](../../04-tareas/101-PedidosWeb/TR-SPEC-101-14-dashboard.md), `GET /api/v1/dashboard/operativo` |
...
│ [Q] [$] (apilados)   │ [Q] [$]            │ [Q] [$]                             │
└──────────────────────────────────────────────────────────────────────────────────┘
(Viewport &lt;960px: los tres grupos vuelven a columna única; en móvil Q y $ pueden ir lado a lado.)
...
- `dashboard.section.*` (presupuestos, pedidosIngresados, pedidosPendientes, topClientes)
- `dashboard.link*` (presupuestos, pedidos, pendientes)
- `dashboard.kpi.*` (etiquetas de cada indicador)
...
| KPIs (8) | `dashboardKpiPresupuestosCantidad`, `dashboardKpiPresupuestosImporte`, `dashboardKpiPedidosIngresadosCantidad`, `dashboardKpiPedidosIngresadosImporte`, `dashboardKpiPedidosPendientesCantidad`, `dashboardKpiPedidosPendientesImporte` |
