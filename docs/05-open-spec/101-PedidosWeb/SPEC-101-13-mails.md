...
- Detalle de renglones (CC PQ #12): columnas **Bultos** (`cantidad_venta`) y **Unidades** (`cantidad` neta/stock). i18n `mail.comprobanteNotification.colBultos` / `colUnidades`. Mostrar ambas cuando `cantidad_venta` está poblada.
...
| 30/08/2026 | Parte I | Unificación `SPEC-101-13-mails-update-01`. Queda abierto `SPEC-101-13-…-update.md` |
